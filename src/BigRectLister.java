...
public class BigRectLister {
    public static void main (String[] args) {
        ...
        Rectangle rectangle7 = new Rectangle(7, 7,7, 7);
        Rectangle rectangle8 = new Rectangle(8, 8,8, 8);
        Rectangle rectangle9 = new Rectangle(9, 9,9, 9);
        Rectangle rectangle10 = new Rectangle(10, 10, 10, 10);
